...
- Uses a function to compute the **sum of the even numbers** in the array.
...
- Print ONLY the sum of even elements, followed by a newline.
...
int sum_of_evens(int *ptr, int size)
{
    int sum = 0;
